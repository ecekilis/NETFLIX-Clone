            ...
            {!movie ? (
                ...
                <>
                    ...
                    <div>
                        <Splide
                            options={{
                                autoWidth: true,// resimlerin genisligini ayarlar
                                pagination: false,// alt taraftaki 3 nokta, sayfalandirma
                                lazyLoad: true,  //Açıklama: Bu seçenek, slaytların sadece gerektiğinde (görünüm alanına girdiğinde) yüklenmesini sağlar. Böylece, sliderın başlangıçta yüklenmesi daha hızlı olur ve sadece görüntülenen slaytlar yüklendiğinden bant genişliği tasarrufu sağlanır.
                                // Kullanım Durumu: Büyük resim galerileri veya ağır içerikli sliderlarda performansı artırmak için idealdir. Kullanıcı yalnızca görüntülediği slaytları indirir, bu da sayfanın yüklenme süresini iyileştirir.
                            }}
                        >
